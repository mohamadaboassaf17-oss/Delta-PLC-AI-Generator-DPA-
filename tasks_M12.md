...
> **✅ بنود مكتملة (8):** كل إصلاحات M12.1 الأربعة، الـ collapse handles + الانتقال السلس (M12.2)، تنظيف الفوتر (M12.3)، وتشغيل كامل test suite (M12.4.2).
>
> **⏳ بنود متوقعة على المالك (2) — مراجعتان بصريتان بشريتان فقط:**
> - M12.4.1 (اختبار بصري على دقتَي 1366×768 و 1920×1080)
> - M12.4.3 (مقارنة بصرية جنباً إلى جنب مع `dpa_layout_fix_preview.html`)
...
> 6. ✅ **M12.4.2** (test suite). ⏳ M12.4.1 + M12.4.3 مراجعة بصرية بشرية على المالك.
