...
export function CounterBlockNode({ data }: NodeProps): React.ReactElement {
  const d = data as unknown as LadderNodeData
  const k = d.kind as Extract<LdNodeKind, { type: 'counter_block' }>
  return (
    <div
      data-testid="ladder-node-counter_block"
